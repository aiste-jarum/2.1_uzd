...
{
public:
    virtual std::string getvardas ()=0;
    virtual std::string getpavarde ()=0;
    virtual void setvardas (std::string)=0;
    virtual void setvardas2 (std::string)=0;
    virtual void setpavarde (std::string)=0;
    virtual void setpavarde2 (std::string)=0;
...
public:
    ...
    int geteg() {return eg;}
    double getvidurkis() {return vidurkis;}
    ...
    void setvidurkis (double v) {vidurkis = v;}
